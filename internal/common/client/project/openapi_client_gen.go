...
type ClientInterface interface {
	...
	GetAllProjects(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetAllProjects(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetAllProjectsRequest(c.Server)
	if err != nil {
		return nil, err
	}
...
func NewGetAllProjectsRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	GetAllProjectsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetAllProjectsResponse, error)
}
...
func (c *ClientWithResponses) GetAllProjectsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetAllProjectsResponse, error) {
	rsp, err := c.GetAllProjects(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
